...
__all__ = [
    ...
    'resnet152_2d3d_full', 'resnet200_2d3d_full', 'select_resnet'
]
...
class Bottleneck2d(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None, track_running_stats=True, use_final_relu=True, batchnorm=True):
